...
#include "ros2_kdl_package/action/detail/execute_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "ros2_kdl_package/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Goal(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_Goal__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_Goal__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ExecuteTrajectory_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _ExecuteTrajectory_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Goal(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_kdl_package, action, ExecuteTrajectory_Goal)() {
...
using _ExecuteTrajectory_Result__ros_msg_type = ros2_kdl_package__action__ExecuteTrajectory_Result;
  ...
  void * untyped_ros_message)
{
  ...
  _ExecuteTrajectory_Result__ros_msg_type * ros_message = static_cast<_ExecuteTrajectory_Result__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_Result__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_kdl_package__action__ExecuteTrajectory_Result;
    is_plain =
      (
...
static size_t _ExecuteTrajectory_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_kdl_package, action, ExecuteTrajectory_Result)() {
...
using _ExecuteTrajectory_Feedback__ros_msg_type = ros2_kdl_package__action__ExecuteTrajectory_Feedback;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 3;
    auto array_ptr = ros_message->position_error;
  ...
  void * untyped_ros_message)
{
  ...
  _ExecuteTrajectory_Feedback__ros_msg_type * ros_message = static_cast<_ExecuteTrajectory_Feedback__ros_msg_type *>(untyped_ros_message);
  // Field name: position_error
  {
    size_t size = 3;
    auto array_ptr = ros_message->position_error;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_Feedback__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_kdl_package__action__ExecuteTrajectory_Feedback;
    is_plain =
      (
      offsetof(DataType, position_error) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _ExecuteTrajectory_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_kdl_package, action, ExecuteTrajectory_Feedback)() {
...
// already included above
// #include "ros2_kdl_package/action/detail/execute_trajectory__functions.h"  // goal
...
using _ExecuteTrajectory_SendGoal_Request__ros_msg_type = ros2_kdl_package__action__ExecuteTrajectory_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros2_kdl_package, action, ExecuteTrajectory_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _ExecuteTrajectory_SendGoal_Request__ros_msg_type * ros_message = static_cast<_ExecuteTrajectory_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_kdl_package__action__ExecuteTrajectory_SendGoal_Request;
    is_plain =
      (
...
static size_t _ExecuteTrajectory_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_kdl_package, action, ExecuteTrajectory_SendGoal_Request)() {
...
using _ExecuteTrajectory_SendGoal_Response__ros_msg_type = ros2_kdl_package__action__ExecuteTrajectory_SendGoal_Response;
  ...
  void * untyped_ros_message)
{
  ...
  _ExecuteTrajectory_SendGoal_Response__ros_msg_type * ros_message = static_cast<_ExecuteTrajectory_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: accepted
  {
    uint8_t tmp;
    cdr >> tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_kdl_package__action__ExecuteTrajectory_SendGoal_Response;
    is_plain =
      (
...
static size_t _ExecuteTrajectory_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_kdl_package, action, ExecuteTrajectory_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_kdl_package, action, ExecuteTrajectory_SendGoal)() {
...
using _ExecuteTrajectory_GetResult_Request__ros_msg_type = ros2_kdl_package__action__ExecuteTrajectory_GetResult_Request;
  ...
  void * untyped_ros_message)
{
  ...
  _ExecuteTrajectory_GetResult_Request__ros_msg_type * ros_message = static_cast<_ExecuteTrajectory_GetResult_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_GetResult_Request__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_kdl_package__action__ExecuteTrajectory_GetResult_Request;
    is_plain =
      (
...
static size_t _ExecuteTrajectory_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_kdl_package, action, ExecuteTrajectory_GetResult_Request)() {
...
// already included above
// #include "ros2_kdl_package/action/detail/execute_trajectory__functions.h"  // result
...
using _ExecuteTrajectory_GetResult_Response__ros_msg_type = ros2_kdl_package__action__ExecuteTrajectory_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros2_kdl_package, action, ExecuteTrajectory_Result
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _ExecuteTrajectory_GetResult_Response__ros_msg_type * ros_message = static_cast<_ExecuteTrajectory_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: status
  {
    cdr >> ros_message->status;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_GetResult_Response__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_kdl_package__action__ExecuteTrajectory_GetResult_Response;
    is_plain =
      (
...
static size_t _ExecuteTrajectory_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_kdl_package, action, ExecuteTrajectory_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_kdl_package, action, ExecuteTrajectory_GetResult)() {
...
// already included above
// #include "ros2_kdl_package/action/detail/execute_trajectory__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _ExecuteTrajectory_FeedbackMessage__ros_msg_type = ros2_kdl_package__action__ExecuteTrajectory_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros2_kdl_package, action, ExecuteTrajectory_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _ExecuteTrajectory_FeedbackMessage__ros_msg_type * ros_message = static_cast<_ExecuteTrajectory_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  // Field name: goal_id
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ExecuteTrajectory_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _ExecuteTrajectory_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_kdl_package
size_t max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_kdl_package__action__ExecuteTrajectory_FeedbackMessage;
    is_plain =
      (
...
static size_t _ExecuteTrajectory_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_kdl_package__action__ExecuteTrajectory_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_kdl_package, action, ExecuteTrajectory_FeedbackMessage)() {
